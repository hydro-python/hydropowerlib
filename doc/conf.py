...
version = '%s' % (hydropowerlib.__version__)
...
htmlhelp_basename = 'hydropowerlib_doc'
...
latex_documents = [
  ('index', 'hydropowerlib.tex', u'hydropowerlib Documentation',
...
man_pages = [
    ('index', 'hydropowerlib', u'hydropowerlib Documentation',
...
texinfo_documents = [
  ('index', 'hydropowerlib', u'hydropowerlib Documentation',
   u'oemof developer group', 'hydropowerlib', 'Calculate feedin time series of hydropower plants from water flow data.',
   'Miscellaneous'),
]
